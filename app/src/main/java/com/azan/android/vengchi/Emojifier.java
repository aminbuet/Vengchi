...
public class Emojifier {
    ...
    /**
     * Method for detecting faces in a bitmap, and drawing emoji depending
     * on facial expression.
     *  @param context The application context.
     * @param picture The picture in which to detect the faces.
     */
    static Bitmap detectFacesOverlayEmoji(Context context, Bitmap picture){
    ...
    private static Bitmap addBitmapToFace(Bitmap backgroundBitmap, Bitmap emojiBitmap, Face face) {
        ...
        // initialize the results bitmap to be a mutual copy of the original image
